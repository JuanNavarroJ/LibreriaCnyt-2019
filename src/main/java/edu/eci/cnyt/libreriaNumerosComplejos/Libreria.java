...
public class Libreria {
    ...
    /**
     * Metodo que permite pasar un numero complejo de sus coordenadas
     * cartesianas a sus coordenadas polares.
     *
     * @param number1	Es el numero complejo el cual se desea obtener sus
     * cordenadas polares
    ...
    /**
     * Metodo que permite pasar de coordenadas polares a coordenadas
     * cartesianas.
     *
     ...
     *
     * @param vector1	Es el primer vector del cual se quiere conseguir su
     * inverso.
     ...
     * @return	Retorna un vector complejo producto de la multiplicacion del
     * escalar por el vector inicial.
     */
    ...
    /**
     * Metodo que permite la multiplicacion escalar entre dos Matrices
     * Complejas.
     *
     * @param matriz1	Es la primera matriz que se quiere multiplicar.
     * @param matriz2	Es la segunda matriz que se quiere multiolicar.
     * @return	Retorna la matriz que es el producto escalar entre la Matriz1 y
     * la Matriz2.
     */
     ...
     *
     * @param matriz	Es la matriz de la cual se quiere obtener su matriz
     * conjugada.
    ...
    /**
     * Metodo que permite obtener la matriz Adjunta, recordemos que una matriz
     * adjunta es una matriz que es transpuesta y conjugada.
     *
     * @param matriz	Es la matriz de la cual se quiere obtener su matriz
     * adjunta.
     ...
     * @return	Retorna Una matriz que es el producto tensor entre la matriz1 y
     * la matriz2.
     */
    ...
    public static NumeroComplejo[][] productoEscalar(NumeroComplejo[][] vector, NumeroComplejo num) {
        if (vector.length > 0) {
            NumeroComplejo[][] resultado = new NumeroComplejo[vector.length][vector[0].length];
            for (int c = 0; c < vector.length; c++) {
                for (int f = 0; f < vector[0].length; f++) {
                    NumeroComplejo prod = producto(vector[c][f], num);
                    resultado[c][f] = prod;
                }
            }
            return resultado;
    ...
    public static NumeroComplejo[][] productoEntreMatrices(NumeroComplejo[][] matr1, NumeroComplejo[][] matr2) {
        if (matr1.length == matr2.length && matr1[0].length == matr2.length) {
            NumeroComplejo[][] resultado = new NumeroComplejo[matr1.length][matr2[0].length];
            if (matr1[0].length == matr2.length) {
                for (int i = 0; i < matr1.length; i++) {
                    for (int j = 0; j < matr2[0].length; j++) {
                        for (int k = 0; k < matr1[0].length; k++) {
                            if (resultado[i][j] == null) {
                                NumeroComplejo num = new NumeroComplejo(0, 0);
                                resultado[i][j] = suma(num, producto(matr1[i][k], matr2[k][j]));
                            } else {
                                resultado[i][j] = suma(resultado[i][j], producto(matr1[i][k], matr2[k][j]));
                            }
                        }
                    }
                }
